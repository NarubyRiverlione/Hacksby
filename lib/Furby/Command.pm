...
my $description = {
    #...
    '350' => '! food, tasty ("mmm, yum")', #! food, tasty ("mmm, yum")
    #...
    ...
    '370' => '', #!
    '371' => '', #!
    '372' => '! Any suckable tasty stuff (like beans) = ("ooh!")', #! "ooh!"
    '373' => '', #!
    '374' => '', #!
    #...
    '376' => '', #!
    ...
    '403' => '', #!
    #...
    '410' => '! (something hot ?)', #! something hot?
    #...
    '412' => '! (something hot ?)', #! something hot?
    '413' => '! (something hot ?)', #! something hot?
    '414' => '', #!
    '415' => '', #!
    '416' => '', #!
    ...
    '706' => 'Event: (?ping )', # sent at random when Furby is idle (like ping, or searching for other Furbys?). Responds with '721'
    '707' => 'Event: (?ping)', # sent at random when Furby is idle (like ping, or searching for other Furbys?). Responds with '722'
    '708' => 'Event: (?speech dang-dang-...)', #  speech: dang-dang-dang-da..... Responds with '723'
    '709' => 'Event: (?speech bo-ga-di-di-do...)', #  speech: bo-ga-di-di-do ... dang-dang-dang-da..... Responds with '724'
    ...
    '714' => 'something that he dislikes (vomit sound, change eyes)', #  something that he dislikes (vomit like sound, changes eyes)
    '715' => 'smoething that he dislikes (speek rapidly)', #  something he dislikes? speaks rapidly
    ...
    '861' => '"huh" (bored?)',
    '862' => 'Command: Sleep! (only servel seconds)', #! sleep (for several seconds)
